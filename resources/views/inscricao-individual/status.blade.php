...
<body class="min-h-screen bg-gradient-to-br from-indigo-100 to-blue-100 font-sans flex items-center justify-center p-6">
  ...
  <div class="w-full max-w-3xl bg-white/80 backdrop-blur-md shadow-xl rounded-2xl p-6">
    ...
    <div class="bg-white/90 rounded-xl shadow p-6 text-center mb-6">
      <h3 class="text-xl font-bold text-gray-700">{{ $inscricao->nome_usual }}</h3>
      <hr class="my-4">
      ...
      <p class="mt-4"><span class="font-semibold text-indigo-700">👕 Camisa:</span><br>
    ...
    @if ($inscricao->status_pagamento == 'Pendente')
      <div class="bg-white/90 backdrop-blur-md rounded-xl shadow-lg p-6 text-center">
        ...
        <img src="/img/qr-individual.jpeg" alt="QR Code Pix"
