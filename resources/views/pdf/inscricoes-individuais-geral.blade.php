...
<head>
    <meta charset="UTF-8">
    <title>Total Geral Individual</title>
    <style>
        ...
        th { background: #25A121FF; color: white; font-size: 9px; }
    </style>
</head>
<body>
<h2>Total de camisas - <span style="color: green;">Pago</span> e <span style="color: #e67e22;">Cortesia</span> (INDIVIDUAIS)</h2>
<table>
    <thead>
        <tr>
            <th>Paróquia</th>
